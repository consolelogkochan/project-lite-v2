...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="{{ asset('images/Logo_icon2.png') }}" type="image/png">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-sky-100 dark:bg-gray-900">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white/70 backdrop-blur-lg shadow-xl overflow-hidden rounded-2xl">
                {{ $slot }}
            </div>
        </div>
    </body>
